...
(function($){
  $.fn.extend({
    ...
    socialProfiles: function(options) {
      ...
      if(options.whatsapp) { listItem += '<li><a href="https://api.whatsapp.com/send?phone=/'+options.whatsapp+'" target="_blank" rel="nofollow" class="aWhatsapp"><span></span></a><span>Whatsapp</span></li>'; }
